...
//        final HashMap<String, Long> pivotsCount = pivotMappings.stream().map(PivotMappingEntity::getGroupId).collect(Collectors.groupingBy(Function.identity(), HashMap::new, Collectors.counting()));
